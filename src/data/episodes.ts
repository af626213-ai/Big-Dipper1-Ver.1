...
export const courseData: CourseData = {
  ...
  episodes: [
    ...
    },
    {
      ...
      key_phrases: [
        { phrase: "carry out ~", explanation: "「～を実行する」。" },
        { phrase: "as well", explanation: "「～もまた同様に」。" }
      ],
    ...
    },
    {
      ...
      vocab_quizzes: [
        { word: "perform", meaning: "演奏する", options: ["演奏する", "休む", "準備する", "聴く"] },
      ...
      key_phrases: [
        { phrase: "focus on ~", explanation: "「～に集中する」。" },
        { phrase: "in the long run", explanation: "「長い目で見れば」。" }
      ],
    ...
    },
    {
      ...
      vocab_quizzes: [
        ...
        { word: "role model", meaning: "手本", options: ["手本", "悪役", "通行人", "審判"] },
        { word: "will", meaning: "意志", options: ["意志", "未来", "過去", "記憶"] },
        { word: "criticism", meaning: "批判", options: ["批判", "賛辞", "応援", "無視"] },
        { word: "directly", meaning: "直接的", options: ["直接的", "間接的", "密かに", "大声で"] }
      ],
      key_phrases: [
        { phrase: "disagree with ~", explanation: "「～に反対する」。" },
        { phrase: "listen to ~", explanation: "「～を聞く」。" }
      ],
